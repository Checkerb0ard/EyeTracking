...
namespace OscCore
{
    public class PropertyOutput : MonoBehaviour
    {
        OscSender m_Sender;
         ...
         Vector2ElementFilter m_SendVector2Elements;
         Vector3ElementFilter m_SendVector3Elements;
        ...
        void Update()
        {
            ...
            switch (m_PropertyTypeName)
            {
                ...
                case "Color":
                case "Color32":
                    if (!m_PreviousColorValue.Equals((Color)value))
                    {
                        m_PreviousColorValue = (Color)value;
                        m_Sender.Client.Send(m_Address, m_PreviousColorValue);
                    }
                    break;
                case "Vector2":
                    SendVector2(value);
